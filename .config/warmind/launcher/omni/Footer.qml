...
Item {
    ...
    Text {
        ...
        text: {
            ...
            if (!it) return "";
            if (footer.omni.passMode) {
                if (it.rowKind === "header") return "↵ autotype";
                if (it.rowKind === "field") {
                    if (it.fieldType === "autotype") return "↵ autotype sequence";
                    if (it.fieldType === "otp") return "↵ copy OTP  ·  Ctrl+↵ copy";
                    return "↵ type  ·  Ctrl+↵ copy";
                }
            }
        ...
        font.pixelSize: 12 * footer.omni.fontScale
