...
Item {
    ...
    function describeBind(dispatcher, arg) {
        ...
        if (d === "exec") {
            ...
            if (a.includes("hyprctl keyword general:gaps_in"))   return "Set inner gaps";
            if (a.includes("hyprctl keyword general:gaps_out"))    return "Set outer gaps";
            if (a.includes("hyprctl keyword general:border_size")) return "Toggle borders";
            ...
            if (a.includes("wlopm --on"))               return "Wake displays";
